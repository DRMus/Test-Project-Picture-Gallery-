...
export default class Authors extends Component {
    ...
    setColors() {
        this.setState({colorStyle: {
            ...
            option: (styles, {isFocused}) => {
                return {
                    ...styles,
                    color: this.props.darkVersion ? isFocused ? "black" : "white" : isFocused ? "white" : "black",
                    backgroundColor: this.props.darkVersion ? isFocused ? "white" : "black" : isFocused ? "black" : "white",
                    fontSize: "0.9vw",
                    padding: "0.7vw",
                    fontWeight: "700"
                }
            ...
            dropdownIndicator: (styles) => ({
                ...styles,
                svg: {
                    fill: this.props.darkVersion ? "rgba(255, 255, 255, 0.3)" : "rgba(0, 0, 0, 0.3)",
                    width: "1vw",
                    height: "1vw"
                },
    ...
    render() {
        return (
            <Select 
                classNamePrefix={this.props.darkVersion ? 'custom-select' : 'custom-select'}
                placeholder='Authors'
                options={this.state.selectOptions}
                isClearable={true}
                isSearchable={false}
                onChange={this.props.getAuthorId}
